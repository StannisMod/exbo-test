package ru.quarter.zc.repack.gloomyfolken.hooklib.helper;
...
public class DictionaryGenerator {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = FileUtils.readLines(new File("C:\\Users\\Quarter\\.gradle\\caches\\minecraft\\de\\oceanlabs\\mcp\\mcp_snapshot\\20171003\\methods.csv"));
        lines.remove(0);
        ...
        DataOutputStream out = new DataOutputStream(new FileOutputStream("C:\\Users\\Quarter\\Documents\\Core\\src\\main\\resources\\assets\\cifrazia\\methods.bin"));
