package ru.quarter.zc.repack.gloomyfolken.hooklib.asm;
...
/**
 * Class places one hook to one method
 * Terminology:
 * hook - the call of your hook-method from extra code
 * targetMethod - method, where the hook would be injected
 * targetClass - class, whose method would be hooked
 * hookMethod - YOUR static method, which represents the hook
 * hookClass - class with HOOK-method
 */
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    public class Builder extends AsmHook {
         ...
         * import static org.cifrazia.repack.gloomyfolken.hooklib.asm.TypeHelper.*
         * //...
